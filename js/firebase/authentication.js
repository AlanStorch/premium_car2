...
function novoUsuario(email, senha) {
  firebase
    ...
    .then((result) => {
      ...
      window.location.href = `${urlApp}/index.html` //Direcionamos o usuário para a tela inicial | ------------------------------ ALTERADO
    })
    .catch(error => {
...
function logoutFirebase() {
  firebase
    ...
    .signOut()
    .then(function () {
      window.location.href = `${urlApp}/index.html` // aqui teria que jogar a pessoa para o inicio novamente. ------------------------------ ALTERADO
